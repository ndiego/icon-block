...
/**
 * Icons that were removed from the @wordpress/icons package. They are kept
 * here so existing blocks referencing these icon names continue to render.
 */

// The core "edit" icon was an alias of "pencil".
export { pencil as edit } from '@wordpress/icons';
